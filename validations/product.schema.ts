 ...
 * categoryId is REMOVED because it's determined by the Brand.
 */
 ...
 * categoryId is REMOVED here as well.
 */
...
/**
 * Schema for adding a new price version.
 * This remains the same as it only deals with pricing values.
 */
