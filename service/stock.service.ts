...
// Helper to get active price for history tracking
...
export const createStockService = async (data: any) => {
  ...
  try {
    ...
    await StockHistory.create({
      ...
      boxQuantityBefore: 0, singleQuantityBefore: 0,
      boxQuantityAfter: stock.boxQuantity, singleQuantityAfter: stock.singleQuantity,
      boxQuantityChange: stock.boxQuantity, singleQuantityChange: stock.singleQuantity,
...
export const restockService = async (stockId: string, data: any) => {
  ...
  try {
    ...
    await StockHistory.create({
      ...
      boxQuantityBefore: beforeBox, singleQuantityBefore: beforeSingle,
      boxQuantityAfter: final.boxes, singleQuantityAfter: final.singles,
...
// Inside services/stock.service.ts
